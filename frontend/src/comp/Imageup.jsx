...
const handleChange = (e) => {
  ...
  return (
    ...
    >
      ...
      {/* File Upload Area */}
      <label className="w-full h-40 flex flex-col items-center justify-center border-2 border-dashed border-blue-500 rounded-lg cursor-pointer hover:bg-blue-50 transition-all">
        {preview ? (
          <motion.img
            src={preview}
            alt="Preview"
      ...
      <motion.button
        ...
        className="bg-blue-500 text-white px-6 py-2 rounded-lg mt-4 shadow-md hover:bg-blue-600 transition-all disabled:opacity-50"
        whileTap={{ scale: 0.9 }}
        disabled={loading}
      >
...
//     const response = await axios.post(
//         "https://backend-e11cajmz1-shreedhar-anands-projects.vercel.app/upload", // ✅ New Vercel Backend URL
